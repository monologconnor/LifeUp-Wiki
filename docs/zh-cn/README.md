...
> 《人升》目前由两名个人开发者和一位测试同学在业余时间维护，在很多方面资源比不上商业作品，但我们会持续更新和处理反馈，让《人升》变得更好。
...
**当然，有可能你完全不需要某个体系，那么也完全并不影响应用的正常使用。**只需要忽略你不需要的模块即可。
...
> 非官方上架的应用市场，一般应用也是没问题的。只不过那边的反馈我们可能没办法关注、回复。但评分之类的操作还是能帮助应用提高曝光率的。
>
> 所以有建议的话，建议还是多重渠道进行反馈~

由于维护的时间成本问题+很多市场的开发者回复也收获不到反馈（用户甚至完全留意不到被回复了），我们会放弃除了**酷安**以外的所有应用市场的回复工作，专心放在QQ群、邮件、会员渠道。
...
目前会员的定价是 12 元终身。（当前日期2022年2月22日）
